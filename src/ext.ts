 ...
 * Create a tab.
 *
 * TODO document pageLoad and also fix a race where the tab might be immediately ready.
 *
 ...
 */
export async function createTab(createProperties: chrome.tabs.CreateProperties): Promise<TabSummary> {
  ...
  return new Promise<TabSummary>((resolve) => {
